  ...
  return (
    <div className="bg-black/60 w-full min-h-[100vh] bg-cover bg-center bg-no-repeat px-12 items-center border-b border-white/50" id='creations'>
      ...
      <div className="flex-1 mr-20">
        ...
        {/* // Image */}
        <div className="w-full md:w-1/2 lg:w-1/3 pt-12">
          <img
      ...
      <div className="flex justify-center md:flex-row px-4 pt-[80px] pb-8">
        ...
        <div className="flex-1 ml-20">
            <h2 className="text-6xl text-menuYellow mb-16 pl-2">Collection Carte / Pays.</h2>

            <div className="flex flex-col items-center text-white ">
              <p className="pt-[10px] text-xl text-center"> Lorsque j’avais réalisé quelques tableaux sur un courant figuratif/abstrait en néo-impressionnisme paraît-il, un ami m’a demandé de lui peindre une oeuvre sur le thème d’un pays en particulier. En étant honnête, je n’avais aucune idée de ce qu’il était possible de faire dans cet univers là, trop de possibilités et très peu d’expérience de mon coté.</p>
              <p className="text-xl text-center pt-4">
              En réfléchissant à ce pays en question, je n’avais que sa silhouette, ses formes, son empreinte sur cette planete bleue. En synthétisant un peu, je cherchais probablement la simplicité et un esthétique épuré. Lorsque j’eu dessiné le contour d’un pays en trait doré, l’envie de refaire un tracé me tentait, puis un autre, et encore un autre. Jusqu’à arriver à un pays totalement plein.</p>
              <p className="text-xl text-center pt-4">En me reculant du tableau, je vis quelque chose de familier,  une ressemblance avec ma deuxième oeuvre “empreinte” représentant une empreinte digitale. C’était frappant, chaque pays est unique, comme une empreinte finalement.</p>
              <p className="text-xl text-center pt-4">Après avoir réalisé ce premier pays, un engouement était créé,  de la, l’histoire des Pays / Cartes vue le jour avec sur chaque pièce, la certitude d’un exemplaire unique. La promesse que chacun des pays / régions / villes. Ne seront qu’en un seul exemplaire.</p>
            </div>
        </div>
      </div>
      ...
      <div className="flex-1 mr-20">
          ...
          <div className="flex flex-col items-center text-white ">
            <p className="pt-[10px] text-xl text-center"> Lorsque Fréquence / Première collection / Pays, voyaient le jour, j’avais de plus en plus l’envie de développer le coté abstrait bicolore noir ou blanc avec de l’or que j’avais commencé avec Fréquence. De la, mon cerveau à cogité, qu’est-ce que je pouvais réaliser qui aurait du sens à vos yeux et aux miens. Quelles idées je pourrai cacher dans mes toiles, quels messages laisser transparaître en elles. </p>
            <p className="text-xl text-center pt-4">
            Chacune des idées qui me viennent en abstrait par rapport aux oeuvres figuratifs néo-impressionnistes, ont une collection à part entière. Sur un courant Abstrait, ces toiles son numérotées et imaginées par notre passé et notre futur, un monde se cache dans chacune d’elle.</p>
            <p className="text-xl text-center pt-4">Entre les traits ou même les feuilles dorés, il y a toujours de la texture dans l’affaire. Je garde dans chaque toile un mystère que peu de personne savent aujourd'hui. Hélas vous ne le saurez sans doute pas aujourd'hui. Mais je laisse votre belle imagination et vos hypothèses prendre route pendant que je continues à développer les idées qui ne cessent de jaillir en moi.</p>
            <p className="text-xl text-center pt-4">Sachez que ce n’est que le début d’une grande aventure artistique entre vous et moi !</p>
          </div>
        </div>
